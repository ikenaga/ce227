...
- **22/10 (Ter)**: (PJ) Inferência por simulação. Resumos da posteriori e preditiva. Introdução mas métodos de simulação da posteriori e ao MCMC  
...
- **05/11 (Ter)**: (PJ) Algorítmo de Gibbs: dos exemplos, distribuição normal e modelo Poisson com 2 níveis hierárquicos
  ...
  [HTML](script/PoissonGammaGibbs.html) 
- **07/11 (Qui)**:
- **12/11 (Ter)**:
- **14/11 (Qui)**:
- **19/11 (Ter)**:
