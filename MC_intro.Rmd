...
Se a gunção $h$ for decomposta de forma a ter um componente que é uma
...
Essa tecnica é usada em muitas situações em estatística. Resumindo,
...
esperado, é netural que consideremos outras funções de densidade além da
